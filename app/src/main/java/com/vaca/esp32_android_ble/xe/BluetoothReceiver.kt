...
import com.example.smart_xe_gimble.xe.XeBleUtils.fetchAlReadyConnection
import com.example.smart_xe_gimble.xe.XeBleUtils.getConnectedBtDevice
    ...
    companion object {
        ...
        fun registerIntentFilter(): IntentFilter {
            ...
            intentFilter.apply {
                ...
                addAction("android.bluetooth.device.action.BOND_STATE_CHANGED"); // 蓝牙连接状态改变
